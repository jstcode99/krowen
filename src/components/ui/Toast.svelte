...
{#if show}
  <div
    class:bg-gray-800={$toast.type === "success"}
    class:bg-red-500={$toast.type === "error"}
    class="absolute w-full z-10 top-2 right-2 max-w-xs text-sm text-white rounded-md shadow-lg mb-3 ml-3"
    role="alert"
  >
