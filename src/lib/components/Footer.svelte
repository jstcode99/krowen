<script>
  ...
  const services = [
    'Desarrollo Web', 'Apps Móviles', 'UI & UX',
    'Chatbots & IA', 'Sistemas a Medida', 'Consultoría'
  ];
</script>
...
<footer>
  <div class="footer-top">
    <div class="footer-brand">
      <a href="/" class="footer-logo">Krowen</a>
      <p class="footer-tagline">Desde la idea<br>hasta la implementación.</p>
      <a href="https://wa.me/573142115239" target="_blank" class="footer-wa">
    ...
    <div class="footer-col">
      <div class="col-title">Páginas</div>
      {#each links as link}
    ...
    <div class="footer-col">
      <div class="col-title">Servicios</div>
      {#each services as s}
